...
site:
	@pushd site && ./mvnw spring-boot:run
	@popd
...
.PHONY: build clean-build test full-deploy format gas flatten gas-snap anvil site balance deposit company-address version